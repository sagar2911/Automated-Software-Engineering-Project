...
//				System.out.print("here");
	...
	public Double getEntropy() {
		return Double.isNaN(entropy / Math.log(list.size()) * Math.log(2.0)) ? 0.0
				: entropy / Math.log(list.size()) * Math.log(2.0);
	}
	...
	public double dist(Cell cell, Cell cell2) {
		if (cell.stringValue.equals(no) && cell2.stringValue.equals(no)) {
			return 1;
		}
		if (!cell.stringValue.equals(cell2.stringValue)) {
			return 1;
		} else {
			return 0;
		}
